  ...
  return (
    <div className="w-full border-b border-ui-border-base bg-ui-bg-subtle">
      <div className="content-container mx-auto flex flex-col lg:flex-row min-h-[75vh]">
        ...
        <aside className="hidden lg:block w-[15%] border-r border-ui-border-base p-2">
                        ...
                        {category.category_children.map((child) => (
                          <li key={child.id}>
                            <a
                              ...
                              className="hover:bg-gray-100 hover:shadow-sm transition-all duration-200 rounded-md px-1 py-0.5"
                              data-testid="category-link"
                            >
                              {child.name}
                            </a>
        ...
        <div className="w-full lg:w-[85%] flex flex-col justify-center items-center text-center p-2 small:p-16 gap-3">
          <span>
